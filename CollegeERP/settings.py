...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://college-erp1-1y04.onrender.com']
...
ASGI_APPLICATION = 'CollegeERP.asgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Enterprise backend for College Management System',
    'VERSION': '1.0.0',
